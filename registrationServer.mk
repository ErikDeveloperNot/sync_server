...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)/opt/openssl/openssl-1.1.1c_install/include $(IncludeSwitch)/Users/user1/udemy/CPP/UdemyCPP/registrationServer_psql/include 
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)ecpg $(LibrarySwitch)ecpg_compat $(LibrarySwitch)pgcommon $(LibrarySwitch)pgfeutils $(LibrarySwitch)pgport $(LibrarySwitch)pgtypes $(LibrarySwitch)pq $(LibrarySwitch)crypto $(LibrarySwitch)ssl 
ArLibs                 :=  "libecpg.a" "libecpg_compat.a" "libpgcommon.a" "libpgfeutils.a" "libpgport.a" "libpgtypes.a" "libpq.a" "libcrypto" "libssl" 
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)/opt/openssl/openssl-1.1.1c_install/lib $(LibraryPathSwitch)/Users/user1/udemy/CPP/UdemyCPP/registrationServer_psql/lib 
